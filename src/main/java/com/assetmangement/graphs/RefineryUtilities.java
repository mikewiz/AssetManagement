 ...
 * 26-Nov-2001 : Changed name to SwingRefinery.java to make it obvious that this is not part of the Java APIs (DG);
 ...
 * 19-Apr-2002 : Renamed JRefineryUtilities-->RefineryUtilities.  Added drawRotatedString() method (DG);
 * 21-May-2002 : Changed frame positioning methods to accept Window parameters, as suggested by Laurence Vanhelsuwe (DG);
